    ...
    <div class="mainpage">
        <div class="search" style="margin-left: 250px;">
            <div class="searchline" style="height: 60px;background-color:#a6d9f4; border-radius: 15px;
                ...
                <el-button type="primary" round style="margin-left: 38%;width: 150px;" @click="getSubDomainEvolutionTables">子域</el-button>
                <el-button type="primary" round style="width: 150px;margin-left: 5%;" @click="getModelEvolutionTables">信息模型</el-button>
            </div>
            <div class="showbox1" style="margin-left: 20px;" v-show="showmodel_evolution_tables">
                <el-table
                    :data="model_evolution_tables"
                    style="width: 100%">>
            ...
            <div class="showbox2" style="margin-left: 20px;" v-show="showsub_domain_evolution_tables">
                <el-table
                    :data="sub_domain_evolution_tables"
                    style="width: 100%">>
