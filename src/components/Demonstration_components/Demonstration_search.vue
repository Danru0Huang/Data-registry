    ...
    <div class="mainpage">
        <div class="modeltree" style="margin-left: 250px;">
            <div slot="header" class="clearfix input-container" style="text-align: center ;height: 60px;background-color:#a6d9f4; border-radius: 15px;
                ...
                <el-select v-model="selectedModelName[0]" 
                    style="margin-left: 45%;"
                    filterable @change="search"
                    placeholder="请选择查询模型" >
                ...
                <el-table
                    ...
                    <el-table-column align="right">
                        <template slot-scope="scope">
                            ...
                            <el-button type="danger" icon="el-icon-delete" @click.native.prevent="deleteRow(scope.$index, tableDataOfmodel)"></el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
