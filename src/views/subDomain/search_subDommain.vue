      ...
      <el-main>
          <el-card class="box-card">
              ...
              <div slot="header" class="clearfix input-container" style="text-align: center;">
                    ...
                    <el-cascader v-model="selectedModelNames"
						:options="optionsOfModelName" filterable clearable
                        @change="searchDetails"
                        placeholder="请选择查询模型与其相关的表格"
                        style="width:250px">
					</el-cascader>
              ...
              <el-row :gutter="7">
                  ...
                  <el-col :span="12">
                    <div class="chart">
                        ...
                        <template>
                            <el-table
                                :data="dialogconceptual_domain[0]"
                                style="width: 100%">
                                <el-table-column type="expand">
                                    <template slot-scope="props">
                                        <el-form label-position="left" inline class="demo-table-expand">
                                            ...
                                            <el-form-item
                                                ...
                                                <el-descriptions border>
                                                    <el-descriptions-item
                                                        label="值含义">{{ item.name }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="标识符">{{ item.identifier }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="注册状态">{{ item.status }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="创建时间">{{ item.time }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="版本">{{ item.version }}</el-descriptions-item>
                                                </el-descriptions>
                                            </el-form-item>
                                        </el-form>
                                    </template>
                        ...
                        <template>
                            <el-table
                                :data="dialogdata_element_concept"
                                style="width: 100%">
                                <el-table-column type="expand">
                                    <template slot-scope="props">
                                        <el-form label-position="left" inline class="demo-table-expand">
                                        ...
                                        <el-form label-position="left" inline class="demo-table-expand">
                                            ...
                                            <el-form-item
                                                ...
                                                <el-descriptions :column="2" border>
                                                    <el-descriptions-item
                                                        label="值">{{ item.PEVName }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="标识符">{{ item.PEVIdentifier }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="值含义">{{ item.VLMName }}</el-descriptions-item>
                                                    <el-descriptions-item
                                                        label="标识符">{{ item.VLMIdentifier }}</el-descriptions-item>
                                                </el-descriptions>
                        ...
                        <el-drawer
                            ...
                            <el-form :label-position="labelPosition" label-width="80px" :model="formLabelAlign">
                                <el-form-item label="名称">
                                    <el-input v-model="formLabelAlign.name" style="width: 400px;margin-left: 10px"></el-input>
                                </el-form-item>
                                <el-form-item label="活动区域">
                                    <el-input v-model="formLabelAlign.region" style="width: 400px;margin-left: 10px"></el-input>
                                </el-form-item>
                                <el-form-item label="活动形式">
                                    <el-input v-model="formLabelAlign.type" style="width: 400px;margin-left: 10px"></el-input>
                                </el-form-item>
                                <el-button type="primary" @click="handleEdit()" style="margin-left: 100px;">提交修改</el-button>
