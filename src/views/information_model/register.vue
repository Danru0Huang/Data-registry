    ...
    <el-container>
        <el-main >
            <el-card class="box-card">
                ...
                <!-- 添加信息模型模块 -->
                <div slot="header" class="clearfix input-container" style="text-align: center; display: flex; align-items: center;margin-left: 25%;">
                    <!-- 添加信息模型按钮 -->
                    ...
                    <el-select v-model="selectedModelName" filterable 
                        ...
                        <el-option v-for="(item, index) in optionsOfModelName" :key="index" 
                            :label="item.label" 
                            :value="item.value">
                        </el-option>
                    </el-select>
                ...
                <el-row :gutter="5">
                    ...
                    <el-col :span="7">
                        ...
                        <el-dialog title="注册模型" :visible.sync="showDialogOfAddModel" width="25%"
                            ...
                            <span>
                                <el-form ref="addModelForm" :model="addModelData" label-width="auto"
                                    ...
                                    <el-form-item label="模型名称:">
                                        <el-input v-model="addModelData.model_name" clearable placeholder="请输入内容"></el-input>
                                    </el-form-item>
                                    <el-form-item label="类名称:">
                                        <el-input v-model="addModelData.class_name" clearable placeholder="请输入内容"></el-input>
                                    </el-form-item>
                                </el-form>
                            </span>
                        ...
                        <el-dialog title="注册属性/关系" :visible.sync="showDialogOfSelect" width="25%"
                            :before-close="dialogClose" center>
                            <span>
                                <el-button type="primary" @click="selectOfAddRelation" style="margin-left: 30px;">注册关系</el-button>
                            </span>
                            <span>
                                <el-button type="primary" @click="selectOfAddProperty" style="margin-left: 30px;">注册属性</el-button>
                            </span>
                            <span slot="footer" class="dialog-footer">
