        ...
        <el-card style="width:100vw;margin:20px;">
                ...
                <el-row>
                    <el-col :span="12">
                        ...
                        <div style="height:600px;width:100%;">
                            <div style="background-color:#a6d9f4;border-radius: 20px;margin:5px;padding:10px;text-align:center">
                                <el-cascader v-model="value_subDomain"
                                    :options="options_subDomain" filterable clearable
                                    @change="searchModelNamesDetails"
                                    placeholder="请选择">
                                </el-cascader>
                                <el-switch
                                    v-model="value1"
                                    active-value="opensubDomain"
                                    inactive-value="offsubDomain"
                                    @change="changeclear"
                            ...
                            <el-row>
                                <el-col :span="6" style="text-align:center">
                                    <span style="font-size: large;margin-top: 5px;margin-bottom: 10px ;display:inline-block;color: #7BC9F4;">子域属性</span>
                                    <br>
                                    <hr style="border-top: 1px solid #7BC9F4;">
                                    <br>
                                    <el-tree :data="tableModelsubDomain"  
                    ...
                    <el-col :span="12">
                        <div style="height:600px;width:100%;">
                            <div style="background-color:#a6d9f4; border-radius: 20px; margin: 5px; padding: 10px; display: flex; align-items: center;">

                            <el-select v-model="selectedModelName" 
                            filterable 
                            @change="searchModelName" 
                            placeholder="请选择查询模型"
                            style="margin-left:10%">
                                <el-option v-for="item in optionsOfModelName" 
                                :key="item.value" 
                                :label="item.label" 
                            ...
                            active-value="openModelName" 
                            inactive-value="offModelName" 
            ...
            <div id="box2" class="box"> 
                <el-row>
                    ...
                    <el-col :span="12">
                        <div style="height:600px;width:100%">
                            <div style="background-color:#a6d9f4; border-radius: 20px; margin: 5px; padding: 10px; height: 60px; display: flex; align-items: center; justify-content: center;">
                            <span style="margin-left:20px;">演化</span>
                            <el-switch v-model="value3" 
                                active-value="openEvolution" 
                                inactive-value="offEvolution" 
                                @change="changeclear" 
                    ...
                    <el-col :span="12">
                        <div style="height:600px;width:100%">
                            <div style="background-color:#a6d9f4; border-radius: 20px; margin: 5px; padding: 10px; display: flex; align-items: center;">
                                <el-select v-model="valueMDRname" 
                                placeholder="请选择数据元" 
                                style="margin-left:10%"
                                @change="getMDRGraph">
                                    <el-option
                                        v-for="item in optionsMDR"
                                        :key="item.value"
                                        :label="item.label"
                                        :value="item.value"
                                        >
                                ...
                                <el-switch
                                    v-model="value4"
                                    active-value="openMDR"
                                    inactive-value="offMDR"
                                    @change="changeclear"
                                    style="margin-left: 10%;">
                                </el-switch>
                            </div>
                    ...
                    <el-dialog title="修改对象类" :visible.sync="dialogFormclassname" width="40%">
                        <el-form :model="formtablevalueMDR.Datavalue">
                            <el-form-item label="对象类:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.name" autocomplete="off" :disabled="true"></el-input>
                            </el-form-item>
                            <el-form-item label="标识符:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.identifier" autocomplete="off" :disabled="true"></el-input>
                            </el-form-item>
                            <el-form-item label="描述:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.describe" autocomplete="off"></el-input>
                            </el-form-item>
                            <el-form-item label="注册状态:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.status" autocomplete="off" :disabled="true"></el-input>
                            </el-form-item>
                            <el-form-item label="创建时间:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.time" autocomplete="off" :disabled="true"></el-input>
                            </el-form-item>
                            <el-form-item label="版本:" >
                                <el-input v-model="formtablevalueMDR.Datavalue.version" autocomplete="off" :disabled="true"></el-input>
                            </el-form-item>
                        ...
                        <el-row class="row-with-divider">
                            <el-col :span="8">
                                <el-form ref="deletetableForm" :model="deletetableName" label-width="auto"
                                    ...
                                    <el-form-item label="表名称:">
                                        <template>
                                            <el-select v-model="deletetableName.value" filterable
                                                default-first-option placeholder="请选择要删除的表:">
                                                <el-option v-for="item in options_table"
                            ...
                            <el-col :span="8">
                                <el-form ref="deletetablepropertyForm" :model="deletetableName1" label-width="auto"
                                    ...
                                    <el-form-item label="表名称:">
                                        <template>
                                            <el-select v-model="deletetableName1.value" filterable
                                                default-first-option placeholder="请选择要删除的表:"
                                                @change="searchtableProperty"
                                                >
                                                <el-option v-for="item in options_table"
                                                    :key="item.value" :label="item.label"
                                                    :value="item.value">
                                    ...
                                    <el-form-item label="表属性:">
                                        <template>
                                            <el-select v-model="deletetablePropertyName.value" filterable
                                                ...
                                                <el-option v-for="item in options_tableproperty"
                                                    :key="item.value" :label="item.label"
                                                    :value="item.value">
                                                </el-option>
                                            </el-select>
                            ...
                            <el-col :span="8">
                                <el-form ref="deletetablepropertyValueForm" :model="deletetableName2" label-width="auto"
                                    ...
                                    <el-form-item label="表名称:">
                                        <template>
                                            <el-select v-model="deletetableName2.value" filterable
                                                default-first-option placeholder="请选择要删除的表:"
                                                @change="searchtablePropertyValue"
                                                >
                                                <el-option v-for="item in options_table"
                                                    :key="item.value" :label="item.label"
                                                    :value="item.value">
                                    ...
                                    <el-form-item label="表属性值:">
                                        <template>
                                            <el-select v-model="deletetablePropertyValueName.value" filterable
                                                ...
                                                <el-option v-for="item in options_tablepropertyValue"
                                                    :key="item.value" :label="item.label"
                                                    :value="item.value">
                                                </el-option>
                                            </el-select>
                                    ...
                                    <el-form-item>
                                        <el-button @click="DeletetablePropertyValueName" style="font-size: 10px;">删除表属性值</el-button>
                                        <el-button type="danger" @click="resetForm">重置</el-button>
                                    </el-form-item>
                                </el-form>
                            </el-col>
            ...
            <div class="buttom">
                <el-steps :active="active" finish-status="success" align-center style="background-color:#c9e8f8;border-radius: 20px;margin:5px;padding:20px">
                    ...
                    <el-card style="max-width:80vw">
                        ...
                        <div v-show="showinformation_model">
                            <div style="display: flex; justify-content: space-between; width: 100%;">
                                <el-button type="success" size="mini" @click="changeShowAddModelClassTable" style="flex: 1;">注册类</el-button>
                                <el-button type="success" size="mini" @click="changeShowAddModelPropertyTable" style="flex: 1;">注册属性</el-button>
                                <el-button type="success" size="mini" @click="changeShowAddModelRelationTable" style="flex: 1;">注册关系</el-button>
                            ...
                            <el-form ref="addModelPropertyTableForm" :model="addPropertyName" label-width="auto"
                                ...
                                <br>
                                <el-form-item label="模型名称:">
                                    <el-input v-model="selectedModelName" :disabled="true" clearable placeholder="请输入内容"></el-input>
                                </el-form-item>
                                ...
                                <el-form-item label="属性名称:">
                                    <template>
                                        <el-cascader v-model="deleteProperty.deletePropertyName"
                                            :options="optionsOfModelPropertyName" filterable clearable
                                            placeholder="请选择">
                                        </el-cascader>
                                    </template>
                                </el-form-item>
                            ...
                            <el-row>
                                <el-col :span="8">
                                    <el-aside>
                                        ...
                                        <el-row>
                                            <el-col>
                                                <el-button class="button" type="success" @click="changeShowConceptualDomainValue">
                                                    新增概念域值含义
                                                </el-button>
                                            </el-col>
                                        </el-row>
                                ...
                                <el-col :span="16">
                                    <el-main style="text-align: center">
                                            ...
                                            <div>
                                                <el-form ref="registerObjectClassForm" :model="registerObjectClassData"
                                                    ...
                                                    <el-form-item label="名称:" prop="name">
                                                        <el-input v-model="registerObjectClassData.name" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="描述:" prop="describe">
                                                        <el-input v-model="registerObjectClassData.describe" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="创建人员ID:" prop="personId">
                                                        <el-input v-model="registerObjectClassData.personId" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item> 
                                                    <el-form-item label="创建单位:" prop="department">
                                                        <el-input v-model="registerObjectClassData.department" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                        ...
                                        <div v-show="showProperty" class="showbox">
                                            ...
                                            <div>
                                                <el-form ref="registerPropertyForm" :model="registerPropertyData" label-width="auto"
                                                    ...
                                                    <el-form-item label="名称:" prop="name">
                                                        <el-input v-model="registerPropertyData.name" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="描述:" prop="describe">
                                                        <el-input v-model="registerPropertyData.describe" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="创建人员ID:" prop="personId">
                                                        <el-input v-model="registerPropertyData.personId" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="创建单位:" prop="department">
                                                        <el-input v-model="registerPropertyData.department" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                ...
                                                <el-form ref="registerDataElementConceptForm"
                                                    ...
                                                    <el-form-item label="对象类:" prop="objectClass">
                                                        <el-select v-model="registerDataElementConceptData.objectClass" filterable
                                                            remote @focus="searchObjectClass" :loading="objectClassLoading"
                                                            :value-key="'label'">
                                                            <!-- {% raw %} -->
                                                    ...
                                                    <el-form-item label="属性" prop="property">
                                                        <el-select v-model="registerDataElementConceptData.property" filterable
                                                            remote @focus="searchProperty" :loading="propertyLoading"
                                                            :value-key="'label'">
                                                            <!-- {% raw %} -->
                                        ...
                                        <div v-show="showValueDomain" class="showbox" style="width:30vw">
                                            ...
                                            <div>
                                                <el-form ref="registerValueDomainForm" :model="registerValueDomainData"
                                                    ...
                                                    <el-form-item label="名称:" prop="name">
                                                        <el-input v-model="registerValueDomainData.name" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="描述:" prop="describe">
                                                            ...
                                                            <el-form-item >
                                                                <div style="align-items:left;">
                                                                    <div style="width: 100%; display: flex;">
                                                                        ...
                                                                        <el-input v-model="item.num" placeholder="请输入组号" clearable ></el-input>
                                                                    </div>
                                                                    <div style="align-items: center; display: flex;">
                                                                        <el-select v-model="item.valueMeaning" filterable remote
                                                                            @focus="searchValueMeanings"
                                                    ...
                                                    <el-form-item label="概念域" prop="conceptualDomain">
                                                        <el-select v-model="registerValueDomainData.conceptualDomain" filterable
                                                            remote @focus="searchConceptualDomain"
                                                            :loading="conceptualDomainLoading" :value-key="'label'" >
                                                            <!-- {% raw %} -->
                                                            <el-option v-for="(option,index) in conceptualDomainOptions" :key="index"
                                                                :label="option.label" :value="option.value">
                                        ...
                                        <div v-show="showDataElement" class="showbox">
                                            ...
                                            <div>
                                                <el-form ref="registerDataElementForm" :model="registerDataElementData"
                                                    ...
                                                    <el-form-item label="名称:" prop="name">
                                                        <el-input v-model="registerDataElementData.name" width="20px" clearable placeholder="请输入内容"></el-input>
                                                    </el-form-item>
                                                    <el-form-item label="描述:" prop="describe">
                                                    ...
                                                    <el-form-item label="数据元概念:" prop="dataElementConcept">
                                                        <el-select v-model="registerDataElementData.dataElementConcept" filterable
                                                            remote @focus="searchDataElementConcept"
                                                    ...
                                                    <el-form-item label="值域:" prop="valueDomain">
                                                        <el-select v-model="registerDataElementData.valueDomain" filterable remote
                                                            @focus="searchValueDomain" :loading="valueDomainLoading"
                                                            :value-key="'label'" >
                                                            <!-- {% raw %} -->
                                        ...
                                        <div v-show="showValueDomainValue" class="showbox" style="width:30vw">
                                            ...
                                            <div>
                                                <el-form ref="registerValueDomainFormvalue" :model="registerValueDomainDataValuelabel"
                                                    label-width="auto" style="margin-top: 20px; width: 90%;"
                                                    v-show="showValueDomainValue">
                                                    <el-form-item label="值域:" prop="registerDomainFormValue">
                                                        <el-select v-model="registerValueDomainDataValuelabel.registerDomainFormValue" filterable
                                                            remote @focus="searchDataDomain"
                                                            :loading="DataDomainLoading" :value-key="'label'" >
                                                            <!-- {% raw %} -->
                                                            <el-option v-for="(option,index) in DataDomainOptions" :key="index"
                                                                :label="option.label" :value="option.value">
                                                                <span style="float: left">{{ option.label }}</span>
                                                                <span
                                                                    style="float: right; color: #8492a6; font-size: 13px">{{ option.value }}</span>
                                                    ...
                                                    <el-form-item>
                                                        <el-button type="primary" @click="registerValueDomainvalue">添加</el-button>
                                                        <el-button type="danger"
                                        ...
                                        <div v-show="showaddConceptualDomain" class="showbox" style="width:33vw">
                                            ...
                                            <div>
                                                ...
                                                <el-form :model="registerConceptualDomainData" ref="registerConceptualDomainForm"
                                                    ...
                                                    <el-form-item>
                                                        <el-button type="primary" @click="registeraddConceptualDomainvalue">注册</el-button>
                                                        <el-button @click="addValueMeaning" icon="el-icon-plus">新增值含义</el-button>
                                                        <el-button type="danger"
                                                            @click="resetFormMDR('registerConceptualDomainForm')">重置</el-button>
                                                    </el-form-item>
