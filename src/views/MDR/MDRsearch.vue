    ...
    <el-container>
      <el-main>
        <el-card class="box-card">
          <div
            slot="header"
            class="clearfix input-container"
          ...
          >
            ...
            <el-dropdown @command="handleCommand">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item command="数据元概念"
                  >数据元概念</el-dropdown-item
                >
          ...
          <el-row :gutter="5">
            ...
            <template>
              <el-table
                :data="
                  tableDataOfConceptualDomain.filter(
                    (data) =>
                      !search ||
                      data.name.toLowerCase().includes(search.toLowerCase())
                  )
                "
                style="width: 100%"
                v-show="showTableOfConceptualDomain"
              >
                <el-table-column type="expand">
                  <template slot-scope="props">
                    <el-form
                    ...
                    >
                      ...
                      >
                      <el-form-item
                        v-for="(item, index) in props.row.valueMeanings
                          .valueMeanings"
                        :key="index"
                      >
            ...
            <template>
              <el-table
                :data="
                  tableDataOfDataElementConcept.filter(
                    (data) =>
                      !search ||
                      data.name.toLowerCase().includes(search.toLowerCase())
                  )
                "
                style="width: 100%"
                v-show="showTableDataElementConcept"
              >
                <el-table-column type="expand">
                  <template slot-scope="props">
                    <el-form
                ...
                <el-table-column type="expand">
                  <template slot-scope="props">
                    ...
                    >
                      ...
                      >
                      <el-form-item
                        v-for="(item, index) in props.row.permissibleValues
                          .permissibleValues"
                        :key="index"
                      >
                  ...
                  <template slot-scope="props">
                    ...
                    >
                      ...
                      <el-form-item label="标识符">
                        <span>{{ props.row.identifier }}</span>
                        <span
                          ><el-link @click="getMDRGraph(props.row.identifier)"
                            ><i
                              class="el-icon-view el-icon--right"
                            ></i> </el-link
                        ></span>
          ...
          <!-- {% raw %} -->
          <el-dialog
            :visible.sync="dialogVisibleObjectClass"
            title="对象类"
            width="50%"
          >
            <el-descriptions border>
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisibleObjectClass = false"
                >关闭</el-button
              >
            </span>
          </el-dialog>
          ...
          <el-dialog
            :visible.sync="dialogVisibleConceptualDomain"
            title="概念域"
            width="50%"
          >
            <el-descriptions border>
            ...
            <div v-if="dialogDataValueMenings">
              <el-descriptions
                v-for="(item, index) in dialogDataValueMenings"
                border
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisibleConceptualDomain = false"
                >关闭</el-button
              >
            </span>
          </el-dialog>
          ...
          <el-dialog
            :visible.sync="dialogVisibleDataElementConcept"
            title="数据元概念"
            width="50%"
          >
            <el-descriptions border>
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisibleDataElementConcept = false"
                >关闭</el-button
              >
            </span>
          </el-dialog>
          ...
          <el-dialog
            :visible.sync="dialogVisibleValueDomain"
            title="值域"
            width="50%"
          >
            <el-descriptions border>
            ...
            <div v-if="dialogDataPermissibleValues">
              <el-descriptions
                v-for="(item, index) in dialogDataPermissibleValues"
                border
                style="margin-bottom: 20px"
                :column="2"
                :key="index"
            ...
            <span slot="footer" class="dialog-footer">
              <el-button @click="dialogVisibleValueDomain = false"
                >关闭</el-button
              >
            </span>
          </el-dialog>
...
export default {
  ...
  methods: {
    ...
    handleCommand(command) {
      var vm = this;
      this.$axios
        .get("http://localhost:5000/search/mdr/getMDRTableList", {
          params: {
            label: command,
          },
        })
    ...
    handleGetMDRTable(identifier, label) {
      ...
      // console.log(label)
      this.$axios
        .get("http://localhost:5000/search/mdr/getMDRTable", {
          params: {
