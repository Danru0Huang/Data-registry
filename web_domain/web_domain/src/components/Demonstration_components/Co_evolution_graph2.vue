        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item v-for="(item, index1) in sub_domain_info" :key="index1">
                <el-descriptions :column="2" border>
                  ...
                  <el-descriptions-item label="取值" v-if="showValue">
                    <div>
                      <el-form-item v-for="(item, index2) in item.value" :key="index2">
                  ...
                  <el-descriptions-item v-if="item.evolution != '暂无演化数据'" label="演化信息">
                    <el-form-item v-for="(evolutionItem, index) in item.evolution" :key="index">
