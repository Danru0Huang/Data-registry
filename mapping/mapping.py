...
# 读取共享域数据和子域数据
SHARED_DOMAIN_FILE = Config.DOMAIN_OUTPUT_FILE  # 共享域数据文件
SUB_DOMAIN_FILE = Config.SUBDOMAIN_DATA_FILE  # 子域数据文件
...
# 存储最终结果到 Excel 文件
output_df.to_excel(Config.MAPPING_RESULTS_FILE, index=False)
